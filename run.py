...
print("\nData retrieved from scraping:")
print("team_comps.team_data =", team_comps.team_data)
print("\n_temp =", _temp)
print("\n_temp1 =", _temp1)
print("\nUpdating champion list with latest...")
champ_and_item.update()
print("Champion list after update:", champ_and_item.champ_data)
print("Done.\n\n")
